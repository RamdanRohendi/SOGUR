...
import com.example.solusinganggur.adapter.ItemListAcceptAdapter;
...
public class PencariKerjaAcceptedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.data_accept);
    ...
    private void getData() {
        reference.child("user").child(getUserID).child("lowongan_pekerjaan").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter = new ItemListAcceptAdapter(dataLamaran, getApplicationContext());
