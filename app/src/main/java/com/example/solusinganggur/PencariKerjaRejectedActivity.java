...
import com.example.solusinganggur.adapter.ItemListRejectAdapter;
...
public class PencariKerjaRejectedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.data_reject);
    ...
    private void getData() {
        reference.child("user").child(getUserID).child("lowongan_pekerjaan").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter = new ItemListRejectAdapter(dataLamaran, getApplicationContext());
