...
public class DetailPekerjaan {
    ...
    public DetailPekerjaan(String namaPerusahaan, String namaHRD, String alamatPerusahaan, String emailPerusahaan, String waktuLowongan, String deskripsiPekerjaan, String koordinatX, String koordinatY) {
    ...
    public DetailPekerjaan(String namaPerusahaan, String deskripsiPekerjaan) {
        this.namaPerusahaan = namaPerusahaan;
        this.deskripsiPekerjaan = deskripsiPekerjaan;
    }

    public DetailPekerjaan(String namaPerusahaan, String alamatPerusahaan, String emailPerusahaan) {
        this.namaPerusahaan = namaPerusahaan;
        this.alamatPerusahaan = alamatPerusahaan;
        this.emailPerusahaan = emailPerusahaan;
    }
